...
publishing artifact provenance in a common format still opens up many automated
analysis and auditing opportunities. Additionally, moving build definitions into
...
This is demo repo and is not intended to be used in production contexts. Reuse
of this code is allowed but we can't make any commitments of future support.
